...
const sidebarItems = [
  ...
  { icon: DollarSign, label: 'Gestão de Parcelas', href: '/admin/installments' },
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className={cn(
        ...
        <div className={cn(
          "px-4 text-[10px] font-medium uppercase tracking-widest text-white opacity-80 mt-auto mb-2",
          isCollapsed && "hidden"
        )}>
          Versão 2.1.0
        </div>
