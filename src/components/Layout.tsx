    ...
    <div className="h-screen bg-slate-50 flex overflow-hidden">
      ...
      <aside className={cn(
        ...
        <div className={cn("transition-all duration-300 shrink-0", isCollapsed ? "p-4" : "p-4 space-y-1", isCaptador ? "border-t-white/10" : "border-t-slate-100")}>
          ...
          <div className={cn(
            "px-4 text-[10px] font-medium uppercase tracking-widest mt-auto mb-2 transition-opacity duration-200",
            isCollapsed ? "hidden" : (isCaptador ? "text-white opacity-80" : "text-slate-900 opacity-70")
          )}>
            Versão 2.1.0
          </div>
          <button 
